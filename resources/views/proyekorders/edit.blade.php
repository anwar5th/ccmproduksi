                ...
                <div class="p-6 text-gray-900">
                    <div class="container mt-5">
                        ...
                        <div class="card border-0 shadow-sm rounded">
                            <div class="card-body">
                                <form action="{{ route('proyekorders.update', $proyekorders->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('kodepo') is-invalid @enderror" name="kodepo" value="{{ old('kodepo', $proyekorders->kodepo) }}" placeholder="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('namaproyek') is-invalid @enderror" name="namaproyek" value="{{ old('namaproyek',$proyekorders->namaproyek) }}" placeholder="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('keteranganpoitem') is-invalid @enderror" name="keteranganpoitem" rows="5" placeholder="">{{ old('keteranganpoitem' ,$proyekorders->keteranganpoitem) }}</textarea>
